...
newphysics.Name = "Villegas on toppppp"
...
Notif({Msg = "Villegas Loaded", Img = "Villegascz"})
...
if v:FindFirstChild("ImageLabel") then
  game.Players.LocalPlayer:Kick("tell the Villegas people to fix their script (and dont worry you're not banned)")
end
end
FOVCircle.Position = game:GetService('UserInputService'):GetMouseLocation();
FOVCircle.Radius = Config.Aimbot.FOV
...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Mikehales7/Darkhub-UI-Library/main/.lua"))()
main = lib:Window()
local w = main:Tab('ZANDRO VILLEGAS')
